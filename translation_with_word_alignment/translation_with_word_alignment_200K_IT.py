...
tokenizer_hl_en_de = AutoTokenizer.from_pretrained("Helsinki-NLP/opus-mt-tc-big-en-it")
model_hl_en_de = AutoModelForSeq2SeqLM.from_pretrained("Helsinki-NLP/opus-mt-tc-big-en-it")
...
def process_chunks(df, chunk_size=10000):
    ...
    for start in range(0, num_rows, chunk_size):
        ...
        chunk_filename = f'subset_2OOK_main_dataset_translated_IT_10K_chunk_after_110K_{start // chunk_size}.csv'
