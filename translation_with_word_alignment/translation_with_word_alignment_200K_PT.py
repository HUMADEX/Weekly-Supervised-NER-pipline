...
tokenizer_hl_en_de = AutoTokenizer.from_pretrained("Helsinki-NLP/opus-mt-tc-big-en-pt")
model_hl_en_de = AutoModelForSeq2SeqLM.from_pretrained("Helsinki-NLP/opus-mt-tc-big-en-pt")
...
#df_original_dataset = df_original_dataset[70000:len(df_original_dataset)]
...
def process_chunks(df, chunk_size=10000):
    ...
    for start in range(0, num_rows, chunk_size):
        ...
        chunk_filename = f'subset_2OOK_main_dataset_translated_PT_10K_chunk_{start // chunk_size}.csv'
