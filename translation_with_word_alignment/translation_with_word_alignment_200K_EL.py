...
tokenizer_hl_en_de = AutoTokenizer.from_pretrained("Helsinki-NLP/opus-mt-en-el")
model_hl_en_de = AutoModelForSeq2SeqLM.from_pretrained("Helsinki-NLP/opus-mt-en-el")
...
df_original_dataset = df_original_dataset[52000:len(df_original_dataset)]
...
def process_chunks(df, chunk_size=10000):
    ...
    for start in range(0, num_rows, chunk_size):
        ...
        chunk_filename = f'subset_2OOK_main_dataset_translated_EL_10K_chunk_after_52K_{start // chunk_size}.csv'
