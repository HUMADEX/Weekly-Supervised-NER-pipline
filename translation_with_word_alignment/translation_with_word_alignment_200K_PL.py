...
tokenizer_hl_en_de = AutoTokenizer.from_pretrained("gsarti/opus-mt-tc-en-pl")
model_hl_en_de = AutoModelForSeq2SeqLM.from_pretrained("gsarti/opus-mt-tc-en-pl")
...
def process_chunks(df, chunk_size=10000):
    ...
    for start in range(0, num_rows, chunk_size):
        ...
        chunk_filename = f'subset_2OOK_main_dataset_translated_PL_10K_chunk_after_70K_{start // chunk_size}.csv'
